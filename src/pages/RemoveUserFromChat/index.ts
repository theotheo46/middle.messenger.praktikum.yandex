...
export class RemoveUserFromChatBase extends Block<AddChatProps> {
  ...
  const withShowModal = withStore((state) => ({showModal: state.showModalRemoveUserFromChat, selectedChat: state.selectedChat}))
  
  export const RemoveUserFromChat = withShowModal(RemoveUserFromChatBase);
